        ...
        <div className="flex-1 overflow-y-auto">
          ...
          <div className="p-6 space-y-4">
            ...
            {user.instagramUrl && (
              <div className="pt-2">
                <a
                  href={user.instagramUrl.startsWith('http') ? user.instagramUrl : `https://instagram.com/${user.instagramUrl.replace('@', '').trim()}`}
                  target="_blank"
                ...
                >
                  ...
                  <span className="text-xs text-violet-300">
                    @{user.instagramUrl.match(/instagram\.com\/([^/]+)\/?$/)?.[1] || user.instagramUrl.replace('@', '').trim()}
                  </span>
                </a>
              </div>
            )}
