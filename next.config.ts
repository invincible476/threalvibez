    ...
    return [
      {
        ...
        headers: [
          ...
          // Set CSP to allow Firebase auth and other necessary domains
          {
            ...
            value: [
              "default-src 'self'",
              // accounts.google.com needed for Google Sign-In popup scripts
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://apis.google.com https://accounts.google.com https://*.firebaseio.com",
              // threalvibez.vercel.app is the same-origin authDomain proxy; accounts.google.com for OAuth token exchange
              `connect-src 'self' https://threalvibez.vercel.app https://accounts.google.com https://*.googleapis.com https://*.firebaseio.com https://*.firebase.com ${firebaseAuthDomain} wss://*.firebaseio.com https://api.cloudinary.com https://media.tenor.com https://*.giphy.com https://*.tenor.com https://*.cloudinary.com https://*.livekit.cloud wss://*.livekit.cloud https://*.livekit.io wss://*.livekit.io`,
              "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://accounts.google.com",
              "font-src 'self' https://fonts.gstatic.com",
              "img-src 'self' data: https: blob: https://*.cloudinary.com https://media.tenor.com https://*.giphy.com",
              // threalvibez.vercel.app needed as same-origin authDomain iframe; accounts.google.com for OAuth
              "frame-src 'self' https://threalvibez.vercel.app https://*.firebaseapp.com https://accounts.google.com",
